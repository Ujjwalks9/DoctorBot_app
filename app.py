...
dbconfig = {'host': '127.0.0.1', 'user': 'root', 'password': 'Anjudk92', 'database': 'oops3'}
dbconfig2 = {'host': '127.0.0.1', 'user': 'root', 'password': 'Anjudk92', 'database': 'auth'}
...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:Anjudk92@localhost/auth'
